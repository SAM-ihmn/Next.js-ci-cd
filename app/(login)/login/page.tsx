...
export default function Page() {
  ...
  return (
    <div
      className={`fullSize flex flex-col justify-center items-center bg-[#F7F7F7]`}
    >
      <div className="w-full lg:w-1/3 md:w-1/2 lg:grayBorder md:grayBorder flex flex-col items-center md:shadow-md lg:shadow-md shadow-grayText ">
        <Image
          src={image}
          alt="interface-taxi-8"
          className="sm:w-3/4 sm:h-64 w-full h-96 lg:object-cover"
        />
        <div className="w-full h-96 sm:h-80  flex flex-col justify-center items-center">
          ...
          {wrongData && (
            <div
              dir="rtl"
              className="w-1/2 text-center bg-salmonPink rounded-md"
            >
